    ...
    return (
        <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.45rem' }}>
                <span style={{ fontSize: '0.9rem' }}>{president.symbol || president.emoji}</span>
                <div style={{
                    fontFamily: FONT.mono, fontSize: '0.45rem', letterSpacing: '0.09em',
                    color: isActive ? 'rgba(200,164,74,0.85)' : 'rgba(140,160,200,0.35)', flex: 1,
                }}>
                    {president.name?.toUpperCase()} — {president.subtitle || president.titre || ''}
                </div>
                <button
                    style={{
                        ...BTN_SECONDARY, fontSize: '0.38rem', padding: '0.14rem 0.42rem',
                        ...(isActive
                            ? { border: '1px solid rgba(200,164,74,0.50)', color: 'rgba(200,164,74,0.90)', background: 'rgba(200,164,74,0.08)' }
                ...
                <button style={{ ...BTN_SECONDARY, padding: '0.1rem 0.3rem', fontSize: '0.7rem' }} onClick={onClose}>✕</button>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.35rem' }}>
                <details style={{ position: 'relative' }}>
                    <summary style={{ listStyle: 'none', cursor: 'pointer', fontSize: '1.2rem', width: '2.8rem', textAlign: 'center', padding: '0.2rem', border: '1px solid rgba(200,164,74,0.18)', borderRadius: '2px' }}>
                        {president.symbol || president.emoji || '★'}
                    </summary>
                    <div style={{ position: 'absolute', zIndex: 200, top: '2.4rem', left: 0, background: 'rgba(8,13,22,0.98)', border: '1px solid rgba(200,164,74,0.22)', borderRadius: '3px', padding: '0.5rem', width: '340px' }}>
                        <EmojiPicker value={president.symbol || president.emoji} onChange={e => { onUpdateField('symbol', e); onUpdateField('emoji', e); }} />
                    </div>
                </details>
                <span style={{ fontSize: '0.40rem', color: 'rgba(140,160,200,0.38)', fontFamily: FONT.mono }}>
                    {president.symbol || president.emoji || '—'}
                </span>
            </div>
            ...
            <textarea
                style={{ ...INPUT_STYLE, width: '100%', minHeight: '48px', resize: 'vertical', fontSize: '0.41rem', fontFamily: FONT.mono, lineHeight: 1.5, marginBottom: '0.35rem' }}
