        ...
        {showNewPresident && (
            <section style={{ ...CARD_STYLE, border: '1px solid rgba(60,200,140,0.22)', padding: '0.7rem', marginBottom: '0.5rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr 1fr', gap: '0.38rem', marginBottom: '0.28rem' }}>
                    ...
                    <input style={INPUT_STYLE} value={nPresD.name} placeholder={isEn ? 'Name' : 'Nom'} onChange={e => setNPresD(d => ({ ...d, name: e.target.value }))} />
                    <input style={INPUT_STYLE} value={nPresD.id} placeholder="id_unique" onChange={e => setNPresD(d => ({ ...d, id: e.target.value }))} />
                </div>
                <input style={{ ...INPUT_STYLE, marginBottom: '0.28rem' }} value={nPresD.subtitle} placeholder={isEn ? 'Subtitle (optional)' : 'Sous-titre (optionnel)'} onChange={e => setNPresD(d => ({ ...d, subtitle: e.target.value }))} />
