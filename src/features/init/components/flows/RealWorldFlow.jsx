// src/features/init/components/flows/RealWorldFlow.jsx

import { useState } from 'react';
import { useLocale, t } from '../../../../ariaI18n';
import { BTN_PRIMARY, BTN_SECONDARY, labelStyle } from '../../../../shared/theme';
import CountryConfig from '../CountryConfig';
import ARIAHeader from '../ARIAHeader';

const DEFAULT_COUNTRY = () => ({
    key: Math.random().toString(36).slice(2),
    type: 'reel', nom: '', regime: 'democratie_liberale',
    terrain: 'coastal', realData: null,
});

export default function RealWorldFlow({ worldName, mode, onBack, onPreLaunch, background }) {
