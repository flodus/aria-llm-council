...
import { VB_W, VB_H, hexCenter } from '../../../shared/utils/hex.js'
import { neonPays } from '../../../shared/utils/palette.js'
import { NUAGES_VISIBLE_MAX_SCALE, genererNuages } from '../../../shared/utils/nuages.js'
    ...
    <div ref={wrapRef}
      ...
      {infoHover && (
        <div style={{
          ...
          <span style={{ fontFamily: 'monospace', fontSize: '1rem', letterSpacing: '0.12em', color: infoHover.couleur }}>
            {infoHover.nom}
          </span>
          <span style={{ fontFamily: 'monospace', fontSize: '0.72rem', letterSpacing: '0.1em', color: 'rgba(180,220,255,0.5)', textTransform: 'uppercase' }}>
            {infoHover.biome}
          </span>
          <span style={{ fontFamily: 'monospace', fontSize: '0.72rem', letterSpacing: '0.08em', color: 'rgba(180,220,255,0.35)' }}>
