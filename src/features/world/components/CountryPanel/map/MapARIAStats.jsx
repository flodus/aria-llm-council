...
export default function ARIAStats({ country, isEn }) {
    ...
    return (
        <section>
        <div className="section-title">{t('MAP_ARIA_LEGIT', lang)}</div>
        ...
        <span>{t('MAP_ARIA_RESISTANCE', lang)}</span><span>{t('MAP_ARIA_SUPPORT_LBL', lang)}</span>
        </div>
        </div>
        </section>
    );
