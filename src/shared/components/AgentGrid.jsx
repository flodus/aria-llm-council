...
// Glow toned down : pas de drop-shadow emoji, pas de textShadow, boxShadow léger
//
// Props :
...
export default function AgentGrid({ agents, selectedId, activeIds, onAgentClick, onResetAll, countLabel, lang }) {
